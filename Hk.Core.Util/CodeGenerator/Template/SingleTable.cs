using Hk.Core.Util.CodeGenerator.Comm;
...
namespace Hk.Core.Util.CodeGenerator.Template
{
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("namespace Hk.Core.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    [Table(\""+ baseConfigModel.EntityClassName + "\")]\r\n");
            sb.Append("    /// <summary>\r\n");            
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            sb.Append("    public class " + baseConfigModel.EntityClassName + " : BaseModel<string>\r\n");
            sb.Append("    {\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Huakang.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace Huakang.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            //sb.Append("    /// 版 本\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hk.Core.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.IRepositorys." + baseConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace  Hk.Core.Repositorys." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");

            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            sb.Append("    public class " + baseConfigModel.ServiceClassName + " : BaseRepository<" + baseConfigModel.EntityClassName + ",string>, " + baseConfigModel.IServiceClassName + "\r\n");
            sb.Append("    {\r\n");

            sb.Append("        public " + baseConfigModel.ServiceClassName + " (IDbContextCore dbContext) : base(dbContext){}\r\n\r\n\r\n");
            ...
            if (bIsQuery)
            {
                ...
                sb.Append("                }\r\n");
                sb.Append("            }\r\n");
                sb.Append("            return FindList(expression).ToList();\r\n");
            }
            else
            {
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace Hk.Core.IRepositorys." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            sb.Append("    public interface " + baseConfigModel.IServiceClassName + ":IRepository<" + baseConfigModel.EntityClassName + ", string>, ITransientDependency");
            sb.Append("    {\r\n");
            sb.Append("        #region 获取数据\r\n");
            if (baseConfigModel.gridModel.IsPage == true)
            {
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace Hk.Core.Business." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            ...
            sb.Append("    {\r\n");
            sb.Append("        private " + baseConfigModel.IServiceClassName + " service = Ioc.DefaultContainer.GetService<" + baseConfigModel.IServiceClassName + ">();\r\n\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hk.Core.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.Business." + baseConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace Hk.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
