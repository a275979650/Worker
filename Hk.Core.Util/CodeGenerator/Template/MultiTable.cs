using Hk.Core.Util.CodeGenerator.Model;
...
namespace Hk.Core.Util.CodeGenerator.Template
{
    /// <summary>
    /// 描 述：代码生成模板（多表）
    /// </summary>
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("using Hk.Core.Data.Models;\r\n");
                sb.Append("using HK.Core.Webs.Operator;\r\n\r\n");


                sb.Append("namespace Hk.Core.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                if (isChildTable)
                {
                    sb.Append("    [Table(\"" + multiTableConfigModel.ChildTableName + "\")]\r\n");
                }
                else
                {
                    sb.Append("    [Table(\"" + multiTableConfigModel.EntityClassName + "\")]\r\n");
                }
                sb.Append("    /// <summary>\r\n");
                ...
                if (isChildTable)
                {
                    sb.Append("    public class " + multiTableConfigModel.ChildTableName + "Entity : BaseModel<string>\r\n");
                }
                else
                {
                    sb.Append("    public class " + multiTableConfigModel.EntityClassName + " : BaseModel<string>\r\n");
                }
                sb.Append("    {\r\n");
                ...
                foreach (var item in gridColumnModel)
                {
                    ...
                    if (isChildTable)
                    {
                        if (column == multiTableConfigModel.ChildTablePk)
                        {
                            sb.Append("        [Key]\r\n");
                        }
                    }
                    else {
                        if (column == multiTableConfigModel.DataBaseTablePK)
                        {
                            sb.Append("        [Key]\r\n");
                        }
                    }
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using Huakang.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace Huakang.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                //sb.Append("    /// 版 本\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hk.Core.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.IRepositorys." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.Data.Repositories;\r\n");
            sb.Append("using Hk.Core.Data.DbContextCore;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using System.Text;\r\n");
            sb.Append("using HK.Core.Webs.Operator;\r\n");
            sb.Append("using Hk.Core.Util.Datas;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Collections.Generic;\r\n\r\n");

            sb.Append("namespace  Hk.Core.Repositorys." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            sb.Append("    public class " + multiTableConfigModel.ServiceClassName + " : BaseRepository<" + multiTableConfigModel.EntityClassName + ",string>, " + multiTableConfigModel.IServiceClassName + "\r\n");
            sb.Append("    {\r\n");


            sb.Append("        public " + multiTableConfigModel.ServiceClassName + " (IDbContextCore dbContext) : base(dbContext){}\r\n\r\n\r\n");
            ...
            if (bIsQuery)
            {
                ...
                sb.Append("                }\r\n");
                sb.Append("            }\r\n");
                sb.Append("            return FindList(expression,pagination);\r\n");
            }
            else
            {
                sb.Append("            return FindList(pagination);\r\n");
            }
            sb.Append("        }\r\n");
            //获取实体
            sb.Append("        /// <summary>\r\n");
            ...
            sb.Append("        {\r\n");
            sb.Append("            return GetSingle(keyValue);\r\n");
            sb.Append("        }\r\n");
            ...
            sb.Append("        {\r\n");
            sb.Append("            return FindList<"+ multiTableConfigModel.ChildTableName + "Entity>(\"select * from " + multiTableConfigModel.ChildTableName + " where " + multiTableConfigModel.ChildTableForeignkey + "='\" + keyValue + \"'\");\r\n");
            ...
            sb.Append("        {\r\n");
            sb.Append("            using (var transaction = DbContext.GetContextTransaction())\r\n");
            sb.Append("            {\r\n");
            sb.Append("                 try\r\n");
            sb.Append("                 {\r\n");
            sb.Append("                     Delete<" + multiTableConfigModel.EntityClassName + ",string>(keyValue);\r\n");
            sb.Append("                     Delete<" + multiTableConfigModel.ChildTableName + "Entity>(t => t." + multiTableConfigModel.ChildTablePk + ".Equals(keyValue));\r\n");
            ...
            sb.Append("                     //明细\r\n");
            sb.Append("                     Delete<" + multiTableConfigModel.ChildTableName + "Entity>(t => t." + multiTableConfigModel.ChildTableForeignkey + ".Equals(keyValue));\r\n");
            ...
            sb.Append("                         Add<"+ multiTableConfigModel.ChildTableName + "Entity>(item);\r\n");
            sb.Append("                     }\r\n");
            sb.Append("                 }\r\n");
            sb.Append("                 else\r\n");
            sb.Append("                 {\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using Hk.Core.Data.Repositories;\r\n");
            sb.Append("using Hk.Core.Util.Datas;\r\n");
            sb.Append("using Hk.Core.Util.Dependency;\r\n");
            sb.Append("using System.Collections.Generic;\r\n\r\n");

            sb.Append("namespace Hk.Core.IRepositorys." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            sb.Append("    public interface " + multiTableConfigModel.IServiceClassName + ":IRepository<" + multiTableConfigModel.EntityClassName + ", string>, ITransientDependency");
            sb.Append("    {\r\n");
            sb.Append("        #region 获取数据\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using Hk.Core.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.IRepositorys." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.Util.Cache;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using Hk.Core.Util.Helper;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using HK.Core.Webs.Operator;\r\n");
            sb.Append("using Hk.Core.Util.Datas;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Hk.Core.Business." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            //sb.Append("    /// 版 本 6.1\r\n");
            //sb.Append("    /// Copyright (c) 2013-2016 上海力软信息技术有限公司\r\n");
            ...
            sb.Append("    {\r\n");
            sb.Append("        private " + multiTableConfigModel.IServiceClassName + " service = Ioc.DefaultContainer.GetService<" + multiTableConfigModel.IServiceClassName + ">();\r\n\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Hk.Core.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Hk.Core.Business." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HK.Core.Webs.Commons;\r\n");
            sb.Append("using Microsoft.AspNetCore.Mvc;\r\n");
            sb.Append("using Hk.Application.Web.Common;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using Hk.Core.Util.Extentions;\r\n");
            sb.Append("using Huakang.Application.Web;\r\n");
            sb.Append("using Hk.Core.Util.Datas;\r\n");
            sb.Append("using Hk.Core.Util.Helper;\r\n");
            sb.Append("using Hk.Core.Business.Cache;\r\n\r\n");


            sb.Append("namespace Hk.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    [Area(\"" + multiTableConfigModel.OutputAreas + "\")]\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 描 述：" + multiTableConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            ...
            sb.Append("            List<"+multiTableConfigModel.ChildTableName+ "Entity> childEntitys = strChildEntitys.ToList<" + multiTableConfigModel.ChildTableName + "Entity>();\r\n");
