...
namespace Hk.Core.Util.Helper
{
    ...
    public class DirFileHelper
    {
        ...
        public DirFileHelper(IHostingEnvironment hostingEnvironment)
        {
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(_hostingEnvironment.WebRootPath + "\\" + dir))
                Directory.CreateDirectory(_hostingEnvironment.WebRootPath + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(_hostingEnvironment.WebRootPath + "\\" + dir))
                Directory.Delete(_hostingEnvironment.WebRootPath + "\\" + dir);
        }
        #endregion
        ...
        {
            if (System.IO.File.Exists(_hostingEnvironment.WebRootPath + file))
            {
                System.IO.File.Delete(_hostingEnvironment.WebRootPath + file);
            }
        }
        #endregion
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (System.IO.File.Exists(_hostingEnvironment.WebRootPath + "\\" + dir1))
                System.IO.File.Move(_hostingEnvironment.WebRootPath + "\\" + dir1, _hostingEnvironment.WebRootPath + "\\" + dir2);
        }
        #endregion
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (System.IO.File.Exists(_hostingEnvironment.WebRootPath + "\\" + dir1))
            {
                System.IO.File.Copy(_hostingEnvironment.WebRootPath + "\\" + dir1, _hostingEnvironment.WebRootPath + "\\" + dir2, true);
            }
        }
        #endregion
        ...
        {
            directoryPath = _hostingEnvironment.WebRootPath+@"\"+directoryPath;
            if (IsExistDirectory(directoryPath))
            {
                //删除目录中所有的文件
                string[] fileNames = GetFileNames(directoryPath);
